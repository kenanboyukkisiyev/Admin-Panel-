...
namespace Calena.Areas.Admin.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,OrderBy,Photo,FullName,Position")] Team team)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,OrderBy,Photo,FullName,Position")] Team team)
        {
            if (ModelState.IsValid)
            {
